...
var TeamFilterPipe = (function () {
    ...
    TeamFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocaleLowerCase() : null;
        return (filterBy ? value.filter(function (team) {
            return (team.teamName.toLocaleLowerCase().indexOf(filterBy) !== -1);
        }) : value);
    };
